...
export default function DataDeletion() {
  return (
    <div className="min-h-screen bg-bg pt-12 md:pt-16 pb-12 px-4">
      <div className="max-w-3xl mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-surface border border-white/5 p-6 md:p-12 rounded-[32px] relative overflow-hidden"
        >
          {/* Decorative background element */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-brand/5 rounded-full blur-[100px] -mr-32 -mt-32" />
          
          <div className="relative z-10">
            <div className="w-12 h-12 bg-brand/10 rounded-2xl flex items-center justify-center mb-6 md:mb-8 border border-brand/20">
              <Trash2 className="w-6 h-6 text-brand" />
            </div>
            
            <h1 className="text-3xl md:text-5xl font-black uppercase italic tracking-tighter text-white mb-6 md:mb-8">
              Data Deletion <span className="text-brand">Instructions</span>
            </h1>
            
            <div className="space-y-6 md:space-y-8 text-text-base leading-relaxed uppercase tracking-widest text-[10px] md:text-xs font-bold">
              <p className="text-white/60">
                If you want your account and all associated data deleted from the SportsBox platform, please follow the steps below:
              </p>
              
              <div className="bg-black/40 p-6 md:p-8 rounded-3xl border border-white/5 space-y-4 md:space-y-6">
                <div className="flex items-center gap-4 text-brand">
                  <Mail className="w-4 h-4 md:w-5 md:h-5" />
                  <span className="text-[9px] md:text-xs">Send an email to:</span>
                </div>
                
                <p className="text-sm md:text-lg font-black text-white lowercase tracking-tight font-sans break-all bg-white/5 p-3 md:p-4 rounded-xl border border-white/5">
                ...
                <div className="pt-4 md:pt-6 border-t border-white/5 space-y-2">
                  ...
                  <p className="text-white font-black italic text-base md:text-lg tracking-normal">Data Deletion Request</p>
                </div>
              </div>
